...
export async function toastScenarios(alice: ElementSession, bob: ElementSession): Promise<void> {
    ...
    await acceptToast(alice, "Help us improve Vnete");
...
<<<<<<< HEAD:test/end-to-end-tests/src/scenarios/toast.js
    await rejectToast(bob, "Help us improve Vnete");
=======
    await rejectToast(bob, "Help improve Element");
>>>>>>> a968b4ce537ba12c4ec9d8d9f4e89c4104abc9b3:test/end-to-end-tests/src/scenarios/toast.ts
