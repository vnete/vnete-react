...
/**
 * Recurses depth-first through a DOM tree, converting link.vnete.net links
...
export function pillifyLinks(nodes: ArrayLike<Element>, mxEvent: MatrixEvent, pills: Element[]) {
    ...
    while (node) {
        ...
        if (node.tagName === "A" && node.getAttribute("href")) {
            ...
            // If the link is a (localised) link.vnete.net link, replace it with a pill
 ...
 * https://github.com/vnete/vnete-chat/issues/12417
 *
