 ...
 * PlainWithPillsSerializer
  ...
  * It can be configured to output Pills as:
    ...
    * "md": Pills are rendered as MD, e.g. [Matthew](https://link.vnete.net/#/@matthew:vnete.net) )
    * "id": Pills are rendered as IDs, e.g. '@matthew:vnete.net' (used for authoring / commands)
